...
pub struct EnrollMatchField {
    ...
    /// Denominator for `method: numeric_magnitude` scoring. See
    /// `super::schema::MatchField::scale_max`.
    #[serde(default)]
    pub scale_max: Option<f64>,
    /// Trusted/preferred values for `method: preferred_value` scoring. See
    /// `super::schema::MatchField::preferred_values`.
    #[serde(default)]
        ...
        let match_fields: Vec<super::schema::MatchField> = self
            ...
            .map(|ef| {
                ...
                super::schema::MatchField {
                    ...
                    weight: ef.weight,
                    fields: bm25_fields,
                    scale_max: ef.scale_max,
                    preferred_values: ef.preferred_values,
                }
            })
            .collect();
